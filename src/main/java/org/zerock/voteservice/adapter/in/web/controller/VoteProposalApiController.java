...
import org.zerock.voteservice.adapter.in.web.domain.data.impl.GrpcProposalPendingResponseResult;
...
import org.zerock.voteservice.adapter.in.web.processor.impl.ProposalCachingProcessor;
import org.zerock.voteservice.adapter.in.web.processor.impl.ProposalPendingProcesor;
import org.zerock.voteservice.adapter.in.web.processor.impl.ProposalValidationProcessor;
...
public class VoteProposalApiController extends VoteApiEndpointMapper {
    ...
    public VoteProposalApiController(
    ...
    public ResponseEntity<? extends ResponseDto> proposalVote(
        ...
        log.debug("{}Proposal Pending PASSED for topic: {}", logPrefix, dto.getTopic());
